...
import { Search as SearchIcon, NotificationsActive as NotificationsActiveIcon } from "@mui/icons-material";
		...
		<div className="header">
			...
			<div className="header-aside">
				<div className="headerProfile">
					...
					{data.map((element: dataParameters, index: number) => {
						return <h4 key={index}>{element.name}</h4>;
					})}
				</div>
